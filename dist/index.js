...
exports.ntc = {
    init: function () {
        ...
        for (var i = 0; i < exports.ntc.names.length; i++) {
            color = "#" + exports.ntc.names[i][0];
            rgb = exports.ntc.rgb(color);
            hsl = exports.ntc.hsl(color);
            // @ts-expect-error 2345
            exports.ntc.names[i].push(rgb[0], rgb[1], rgb[2], hsl[0], hsl[1], hsl[2]);
        }
    },
    name: function (color) {
        ...
        var rgb = exports.ntc.rgb(color);
        var r = rgb[0], g = rgb[1], b = rgb[2];
        var hsl = exports.ntc.hsl(color);
        ...
        for (var i = 0; i < exports.ntc.names.length; i++) {
            ...
            // @ts-expect-error 2363
            ndf2 = Math.pow(h - exports.ntc.names[i][5], 2) + Math.pow(s - exports.ntc.names[i][6], 2) + Math.pow(l - exports.ntc.names[i][7], 2);
            ndf = ndf1 + ndf2 * 2;
            if (df < 0 || df > ndf) {
                df = ndf;
                cl = i;
